<?php
class m_voipreports_aibulat_report
{
    ...
    function voipreports_aibulat_report()
    {
        global $pg_db, $design;
        ...
        if ($f_instance_id && $f_operator_id) {
            ...
            foreach($report as $k => $r) {
                if ($f_include_initiate == 't' && $r['initiate_price']) {
                ...
                $r['nds'] = ($r['amount'] + $initiate_amount) * 0.18;
        ...
        $design->AddMain('voipreports/aibulat_report.html');
    }
}