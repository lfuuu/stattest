...
class EntryPointColumn extends DataColumn
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->filter = EntryPoint::getList($this->isWithEmpty, $this->isWithNullAndNotNull);
        !isset($this->filterOptions['class']) && ($this->filterOptions['class'] = '');
        $this->filterOptions['class'] .= ' sim-card-entry_point_id-column';
    }
    ...
    protected function renderDataCellContent($model, $key, $index)
    {
        ...
        if ($this->isAddLink) {
            return Html::a($strValue, EntryPoint::getUrlById($value));
        }
