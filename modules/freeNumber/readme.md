...
При изменении статуса номера сразу же приходит уведомление в free_numbers RabbitMQ.
* Когда номер становится свободным - `['number' => $number, 'action' => 'free']`
* Когда номер становится несвободным - `['number' => $number, 'action' => 'busy']`
