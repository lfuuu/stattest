...
<?= app\classes\Html::formLabel($this->title = 'Статусы направлений') ?>
<?= Breadcrumbs::widget([
    'links' => [
        ['label' => 'Национальный номерной план', 'url' => '/nnp/'],
        ['label' => $this->title, 'url' => '/nnp/status/'],
    ],
]) ?>
...
$columns = [
    [
        ...
        'buttons' => [
            ...
            'delete' => function ($url, Status $model, $key) use ($baseView) {
