...
class m_voipnew_operators
{
    ...
    public function voipnew_operators()
    {
        ...
        $res = $pg_db->AllRecords(" select o.region, o.id, o.short_name, o.term_in_cost, o.local_network_id, o.local_network_pricelist_id, o.pricelist_id, o.operator_7800_pricelist_id, o.client_7800_pricelist_id
