    ...
    <?php if ($file = $model->mediaManager->getFile()) : ?>
        <div class="form-group col-sm-12">
            ...
            <div class="col-sm-8" style="text-align: right; padding-bottom: 5px;">
                <a href="<?= Url::toRoute(['/notifier/email-templates/download-template', 'countryId' => $model->country_id, 'templateId' => $model->template_id, 'langCode' => $model->lang_code]) ?>" class="btn btn-default">
