...
// столбцы с ресурсами
$resources = ResourceClass::findAll(['service_type_id' => $serviceType->id]);
foreach ($resources as $resource) {
    if (in_array($resource->id, [ResourceClass::ID_VOIP_PACKAGE_CALLS, ResourceClass::ID_VOIP_PACKAGE_CALLS])) {
        continue;
    }
