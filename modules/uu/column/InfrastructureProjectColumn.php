...
class InfrastructureProjectColumn extends DataColumn
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->filter = AccountTariff::getInfrastructureProjectList($isWithEmpty = true, $isWithNullAndNotNull = false);
