    ...
    public function search()
    {
        ...
        switch ($this->tariff_period_id) {
            ...
            case TariffPeriod::IS_NOT_SET:
                $query->andWhere([$accountLogResourceTableName . '.tariff_period_id' => null]);
                break;
            case TariffPeriod::IS_SET:
                $query->andWhere($accountLogResourceTableName . '.tariff_period_id IS NOT NULL');
                break;
            default:
                $query->andWhere([$accountLogResourceTableName . '.tariff_period_id' => $this->tariff_period_id]);
                break;
        }
