 ...
 *
 * @method static TariffVoipCountry findOne($condition)
 * @method static TariffVoipCountry[] findAll($condition)
 */
class TariffVoipCountry extends ActiveRecord
{
