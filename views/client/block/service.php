    ...
    <div class="service">
        <div class="row" style="padding-left: 15px;">
            ...
            <?php if ($services['device']) : ?>
                <div id="device">
                    <h3><a href="/?module=routers&action=d_list">Клиентские устройства</a> (<a href="/transfer/index/?client=9130&usages=TechCpe" onClick="return showIframePopup(this)">перенос устройств</a>)</h3>
                    <table cellspacing="4" cellpadding="2" width="100%" border="0">
                        <thead>
                        <tr bgcolor="#FFFFD8">
                            <th width="5%">id</th>
