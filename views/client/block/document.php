...
<div class="data-block">
            ...
            <div class="fullTable row" style="display: none;">
                ...
                <div class="col-sm-12" style="margin-top: 5px;">
                    <form action="/document/create?id=<?= $client->id ?>" method="post">
                        ...
                        <div class="col-sm-2">
                            <select class="text" name="contract_template"
    ...
    <div class="row">
        <div class="col-sm-2 showFullTable" style="cursor: pointer;">
            <a><img class="icon" src="/images/icons/monitoring.gif" alt="Посмотреть"></a>Бланк заказа
        </div>
        <div class="col-sm-10">
            <?php foreach ($docs as $doc)
            ...
            <div class="fullTable row" style="display: none;">
                ...
                <div class="col-sm-12" style="margin-top: 5px;">
                    <form action="/document/create?id=<?= $client->id ?>" method="post">
                        ...
                        <div class="col-sm-2">
                            <select class="text" name="contract_template_group" id="contract_template_group_contract"
                                    onchange="do_change_template_group(this, 'contract')">
                                <option value="MCN">MCN</option>
                                <option value="Межоператорка">Межоператорка</option>
                                <option value="Партнеры">Партнеры</option>
                        ...
                        <div class="col-sm-2">
                            <select class="text" name="contract_template" id="contract_template_contract">
                                <option value="Dog_UslugiSvayzi">Dog_UslugiSvayzi</option>
                            </select>
                        </div>
    ...
    <div class="row">
        <div class="col-sm-2 showFullTable" style="cursor: pointer;">
            <a><img class="icon" src="/images/icons/monitoring.gif" alt="Посмотреть"></a>Доп. соглашения
        </div>
        <div class="col-sm-10">
            <?php foreach ($docs as $doc)
            ...
            <div class="fullTable row" style="display: none;">
                ...
                <div class="col-sm-12" style="margin-top: 5px;">
                    <form action="/document/create?id=<?= $client->id ?>" method="post">
                        ...
                        <div class="col-sm-2"><input class="text" type="text" name="comment"></div>
                        <div class="col-sm-2">
                            <select class="text" name="contract_template_group" id="contract_template_group_agreement"
                        ...
                        <div class="col-sm-2">
                            <select class="text" name="contract_template" id="contract_template_agreement">
