...
echo Html::formLabel('Список почтовых оповещений');
echo Breadcrumbs::widget([
    'links' => [
        'Шаблоны',
        ['label' => 'Почтовые оповещения', 'url' => Url::toRoute(['/templates/email/template'])]
    ],
]);
...
echo GridView::widget([
    ...
    'columns' => [
        [
            ...
            'format' => 'raw',
            'value' => function($data) {
                return Html::a($data->name, ['/templates/email/template/edit', 'id' => $data->id]);
            },
            'width' => '*',
        ],
        [
