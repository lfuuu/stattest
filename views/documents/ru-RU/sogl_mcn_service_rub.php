...
$organizationRetail = Organization::find()->byId(Organization::MCN_TELECOM_RETAIL)->actual()->one(); //Ретайл
    ...
    <body>
        <div class="Section1">
            ...
            <p style="<?=$fsStyle?>text-align: center;" align="center">по
                Договору между ООО «МСН Телеком Ритейл» и <?=$contragent->name_full?> №<?= $contractNumber ?></p>
            ...
            <p style="<?=$fsStyle?>text-align: justify; text-indent: 35.0pt;">
                ООО «МСН Телеком Ритейл» в лице Генерального директора Бирюковой Натальи Викторовны, действующей на основании Устава, с одной стороны, и ООО «МСН Телеком Сервис» в лице Генерального директора Кима Александра Геннадьевича, действующего  на основании Устава, с другой стороны, при совместном упоминании именуемые Стороны, заключили настоящее Соглашение (далее - «Соглашение») о передаче прав и обязанностей по Договору между ООО «МСН Телеком Ритейл»
                и <?=$contragent->name_full?> №<?= $contractNumber ?> г. (далее - Договор) о нижеследующем:
                </p>

            <p style="<?=$fsStyle?>text-align: justify;">1. ООО «МСН Телеком Ритейл» с <?=$dateStr?> передает все свои права и обязанности по Договору, а ООО «МСН Телеком Сервис» принимает на себя с <?=$dateStr?> все передаваемые ООО «МСН Телеком Ритейл» права и обязанности по Договору. Объем уступаемых прав по Договору определяется согласно сведениям  о балансе, размещенным в личном кабинете на момент передачи прав.</p>
            <p style="<?=$fsStyle?>text-align: justify;">2. Стоимость уступки прав  по  Договору равна Объему уступаемых прав.</p>
            <p style="<?=$fsStyle?>text-align: justify;">3. ООО «МСН Телеком Ритейл» извещает о том, что вся поступающая корреспонденция и платежи  в рамках исполнения Договора с <?=$dateStr?> должны быть адресованы  ООО «МСН Телеком Сервис».</p>
            <p style="<?=$fsStyle?>text-align: justify;">4. Настоящее Соглашение вступает в законную силу с даты его подписания Сторонами.</p>
            <p style="<?=$fsStyle?>text-align: justify;">5. Передача прав и обязанностей в соответствии с настоящим Соглашением не влечет за собой каких-либо изменений условий Договора, кроме оговоренных в настоящем Соглашении.</p>
            <p style="<?=$fsStyle?>text-align: justify;">6. Настоящее Соглашение составлено на одном листе, в двух экземплярах, имеющих одинаковую юридическую силу, по одному для каждой из Сторон, и является неотъемлемой частью Договора.</p>
            ...
            <p style="<?=$fsStyle?>margin-right: -2.0pt; text-align: justify;">
                <strong style="mso-bidi-font-weight: normal;">Общество с ограниченной ответственностью  «МСН Телеком Ритейл»</strong><br>
                Юридический адрес: 119313, Москва, Ленинский проспект, д. 95, этаж цокольный, помещение X, офис 69<br>
                ОГРН 1157746324834<br>
                ИНН: 7728226648; КПП: 773601001;<br>
                Банковские реквизиты:<br>
                р/с 40702810038000034045 в Московском Банке Сбербанка России ПАО г. Москва<br>
            ...
            <p style="<?=$fsStyle?>">
                ...
                <tr style="height: 78px;">
                    <td><br><br>Генеральный директор ООО «МСН Телеком Ритейл»<br>Н.В. Бирюкова<br><br><br></td>
                ...
                <p style="<?=$fsStyle?>text-align: justify;">
                    <strong style="mso-bidi-font-weight: normal;">Общество с ограниченной ответственностью «МСН Телеком Сервис»</strong><br>
