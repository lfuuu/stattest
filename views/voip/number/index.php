...
$columns = [
    ...
    [
        ...
        'value' => function ($model) {
            return ($model->calls_per_month_3 !== null ? $model->calls_per_month_3 : '(не задано)') . "\n" .
                   ($model->unique_calls_per_month_3 !== null ? $model->unique_calls_per_month_3 : '(не задано)');
        },
    ],
    [
        ...
        'contentOptions' => ['style' => 'white-space:pre-wrap; word-wrap:break-word'],
        'value' => function ($model) {
            return ($model->calls_per_month_2 !== null ? $model->calls_per_month_2 : '(не задано)') . "\n" .
                   ($model->unique_calls_per_month_2 !== null ? $model->unique_calls_per_month_2 : '(не задано)');
        },
    ],
    [
        ...
        'contentOptions' => ['style' => 'white-space:pre-wrap; word-wrap:break-word'],
        'value' => function ($model) {
            return ($model->calls_per_month_1 !== null ? $model->calls_per_month_1 : '(не задано)') . "\n" .
                   ($model->unique_calls_per_month_1 !== null ? $model->unique_calls_per_month_1 : '(не задано)');
        },
    ],
    [
        ...
        'contentOptions' => ['style' => 'white-space:pre-wrap; word-wrap:break-word'],
        'value' => function ($model) {
            return ($model->calls_per_month_0 !== null ? $model->calls_per_month_0 : '(не задано)') . "\n" .
                   ($model->unique_calls_per_month_0 !== null ? $model->unique_calls_per_month_0 : '(не задано)');
        },
    ],
    [
        'attribute' => 'usage_id',
