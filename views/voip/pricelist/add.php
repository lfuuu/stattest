...
<div class="well">
    ...
    echo Form::widget([
        ...
        'attributes' => [
            ...
            'connection_point_id' => ['type' => Form::INPUT_DROPDOWN_LIST, 'items'=> Region::getList($isWithEmpty = true, $countryId = null, [Region::TYPE_HUB, Region::TYPE_POINT, Region::TYPE_NODE]), 'options' => ['class' => 'select2']],
