...
$(function () {
    ...
    $('select[name="CallsRawFilter[src_contries_ids][]"]')
        .on('change', function () {
            ...
            $.get("/voip/raw/get-regions", {
                countryCode: src_contries_ids.val()
            }, function (data) {
    ...
    $('select[name="CallsRawFilter[dst_contries_ids][]"]')
        .on('change', function () {
            ...
            $.get("/voip/raw/get-regions", {
                countryCode: dst_contries_ids.val()
            }, function (data) {
