...
$defaultColumnsParams = [
    ...
    'id' => [
        'attribute' => 'id',
        'filter' => '<input name="id" class="form-control" />',
        'format' => 'raw',
        'value' => function ($data) {
    ...
    'company' => [
        ...
        'filter' => '<input name="companyName" id="searchByCompany" class="form-control" />',
    ],
    'created' => [
        'attribute' => 'created',
        'format' => 'raw',
    ...
    'service' => [
        ...
        'filter' => function () {
            return \yii\helpers\Html::dropDownList('service', null, [
                'emails' => 'emails',
                'tech_cpe' => 'tech_cpe',
    ...
    'currency' => [
        ...
        'filter' => function () {
            return \yii\helpers\Html::dropDownList('currency', null, \app\models\Currency::map(), ['class' => 'form-control']);
        },
    ],
    'sale_channel' => [
