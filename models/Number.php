...
class Number extends ActiveRecord
{
    ...
    public static function getNumberBeautyLvl($number)
    {
        ...
        if (
             ...
             */
            preg_match('/^(\d)\1\1\1\1\1\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1\1\1\1\d$/', $number) ||
            preg_match('/^\d(\d)\1\1\1\1\1$/', $number) ||

            /**
             * 6 цифр не подряд + 1 в середине
             * @example XXX-Y-XXX 666-2-666
             */
            preg_match('/^(\d)\1\1\d\1\1\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\d\1\1\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\d\1\1\1\1$/', $number) ||
            // preg_match('/^(\d)\1\1\d\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\1\d\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\1\1\d\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1(\d)\2\2\2\2$/', $number) ||
            preg_match('/^(\d)\1\1\1\1(\d)\2$/', $number) ||
            preg_match('/^(\d)(\d)\2\2\2\2\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1(\d)\2\2\2$/', $number) ||
            preg_match('/^(\d)\1\1\1(\d)\2\2$/', $number) ||

            /**
             * 3 одинаковых в середине сподряд + 4 одинаковых
             * @example XX-YYY-XX 22-555-22
             */
            preg_match('/^(\d)\1(\d)\2\2\1\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1\1(\d)\2\1$/', $number) ||
            preg_match('/^(\d)(\d)\2\1\1\1\1$/', $number) ||
            preg_match('/^(\d)\1(\d)\2\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1(\d)\2\1\1$/', $number) ||
             ...
             */
            preg_match('/^\d\d(\d)\1\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\1\1\d\d$/', $number) ||
            preg_match('/^\d(\d)\1\1\1\1\d$/', $number) ||
             ...
             */
            preg_match('/^(\d)(\d)\1\2\1\2\1$/', $number) ||
            preg_match('/^\d(\d)(\d)\1\2\1\2$/', $number) ||
            preg_match('/^(\d)(\d)\1\2\1\2\d$/', $number) ||
             ...
             */
            preg_match('/^\d(\d)\1\1(\d)\2\2$/', $number) ||
            preg_match('/^(\d)\1\1(\d)\2\2\d$/', $number) ||
            preg_match('/^(\d)\1\1\d(\d)\2\2$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1\1(\d)\1\2$/', $number) ||
            preg_match('/^(\d)\1\1\1(\d)\2\1$/', $number) ||
            preg_match('/^(\d)(\d)\2\1\1\1\1$/', $number) ||
            preg_match('/^(\d)(\d)\1\2\2\2\2$/', $number) ||
             ...
             */
            preg_match('/^\d\d\d(\d)\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\1\d\d\d$/', $number) ||
             ...
             */
            preg_match('/^(\d)(\d)\2\2\2\1\1$/', $number) ||
            preg_match('/^(\d)\1(\d)\2\2\2\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1(\d)(\d)\2\3$/', $number) ||
            preg_match('/^(\d)\1\1(\d)\1\2\1$/', $number) ||
            preg_match('/^(\d)(\d)(\d)\3\3\1\2$/', $number) ||
            preg_match('/^(\d)(\d)\1\2(\d)\3\3$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1(\d)\d\1\1\2$/', $number) ||
            preg_match('/^(\d)(\d)\2\d\1\2\2$/', $number) ||
            preg_match('/^(\d)(\d)\1\d\1\2\1$/', $number) ||
            preg_match('/^(\d)(\d)(\d)\d\1\2\3$/', $number) ||
             ...
             */
            preg_match('/^\d\d\d(\d)(\d)\1\2$/', $number) ||

            /**
             * "Безобразный" - стандартный номер
             */
            0
        ) {
            return 1;
        ...
        if(
             ...
             */
            preg_match('/^(\d)\1\d\d\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\d\d\1\1$/', $number) ||

            /**
             * 3 одинаковых + 4 одинаковых (из них 3 подряд)
             * @example XXY-XY-YY 225-25-55
             */
            preg_match('/^(\d)\1(\d)\1\2\2\2$/', $number) ||
             ...
             */
            preg_match('/^(\d)(\d)(\d)\1\2\3\d$/', $number) ||
            preg_match('/^(\d)(\d)\2\1\2\2\1$/', $number) ||
            preg_match('/^(\d)(\d)\1\1\2\1\d$/', $number) ||
            preg_match('/^(\d)(\d)\2\1\2\2\d$/', $number) ||
             ...
             */
            preg_match('/^\d(\d)(\d)(\d)\1\2\3$/', $number) ||
            preg_match('/^\d(\d)\1(\d)\1\1\2$/', $number) ||
            preg_match('/^(\d)\1(\d)\1\1\2\d$/', $number) ||
            preg_match('/^\d(\d)(\d)\2\1\2\2$/', $number) ||
            preg_match('/^\d(\d)(\d)\1\1\2\1$/', $number) ||
             ...
             */
            preg_match('/^\d(\d)\1\1(\d)\1\2$/', $number) ||
            preg_match('/^\d(\d)\1(\d)\1\2\1$/', $number) ||
             ...
             */
            preg_match('/^(\d)(\d)\2\1\1\2\2$/', $number) ||
            preg_match('/^(\d)\1(\d)\1\1\2\2$/', $number) ||
            preg_match('/^(\d)(\d)\1\2\2\1\1$/', $number) ||
            preg_match('/^(\d)(\d)\1\1\1\2\2$/', $number) ||
             ...
             */
            preg_match('/^\d(\d)\1\1(\d)\2\d$/', $number) ||
            preg_match('/^\d(\d)\1(\d)\2\2\d$/', $number) ||
            preg_match('/^\d\d(\d)\1(\d)\2\2$/', $number) ||
            preg_match('/^\d\d(\d)\1\1(\d)\2$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1\1(\d)\2\d\1$/', $number) ||
            preg_match('/^(\d)\1\1(\d)\2\d\2$/', $number) ||
             ...
             */
            preg_match('/^\d(\d)\1\d\1\1\1$/', $number) ||
            preg_match('/^(\d)\1\1\d\1\d\1$/', $number) ||

            /**
             * 3 одинаковые цифры в начале + 2 одинаковые в парах
             * @example XXX-AZ-BZ 222-31-51
             */
            preg_match('/^(\d)\1\1\d(\d)\d\2$/', $number) ||
             ...
             */
            preg_match('/^\d\d(\d)\1\1\1\d$/', $number) ||
            preg_match('/^\d(\d)\1\1\1\d\d$/', $number) ||
            preg_match('/^\d(\d)\1\d\d\1\1$/', $number) ||
            preg_match('/^\d\d(\d)\1\d\1\1$/', $number) ||
            preg_match('/^\d\d(\d)\1\1\d\1$/', $number) ||

            /**
             * 2 зеркальные пары в номере
             * @example NUM-XY-YX 792-34-43
             */
            preg_match('/^\d\d\d(\d)(\d)\2\1$/', $number) ||
        ...
        if(
             ...
             */
            preg_match('/^\d(\d)(\d)\d\2\1\2$/', $number) ||
             ...
             */
            preg_match('/^\d\d\d\d(\d)\1\1$/', $number) ||
            preg_match('/^\d\d(\d)\1\1\d\d$/', $number) ||
            preg_match('/^\d\d\d(\d)\1\1\d$/', $number) ||
            preg_match('/^\d(\d)\1\1\d\d\d$/', $number) ||

            /**
             * 2 одинаковые пары подряд в начале номера
             * @example XY-XY-NUM 64-64-875
             */
            preg_match('/^(\d)(\d)\1\2\d\d\d$/', $number) ||
             ...
             */
            preg_match('/^(\d)\1(\d)\2\d\d\d$/', $number) ||
            preg_match('/^(\d)\1\1\d(\d)\2\d$/', $number) ||
            preg_match('/^\d(\d)\1\d(\d)\2\d$/', $number) ||
            preg_match('/^\d(\d)\1\d\d(\d)\2$/', $number) ||
            preg_match('/^(\d)\1\d\d\d(\d)\2$/', $number) ||

            preg_match('/^(\d)(\d)(\d)\d\3\2\1$/', $number) ||
            preg_match('/^\d\d(\d)(\d)\2\1\d$/', $number) ||
            preg_match('/^\d(\d)(\d)\1\2\d\d$/', $number) ||

            /**
             * 2 пары одинаковых цифр подряд в конце номера
             * @example NUM-XX-YY 283-22-00
             */
            preg_match('/^\d\d\d(\d)\1(\d)\2$/', $number) ||
            //preg_match('/^\d\d\d(\d)\1(\d)\2$/', $number) ||
        ...
        if(
             ...
             */
            //preg_match('/^\d\d(\d)(\d)\1\2\d$/', $number) ||
            //preg_match('/^\d\d(\d)\1(\d)\2\d$/', $number) ||
            //preg_match('/^\d(\d)(\d)\2\1\d\d$/', $number) ||
            //preg_match('/^\d(\d)(\d)\1\2\d\d$/', $number) ||
            preg_match('/^\d\d\d(\d)\1\d\1$/', $number) ||
            preg_match('/^\d\d\d\d\d(\d)\1$/', $number) ||
        ...
        /**
         * "Безобразные" - стандартные номера
         */
        return 0;
    }
