...
class m160516_200500_convert_sms_account_tariff extends \app\classes\Migration
{
    /**
     * Накатить
     */
  ...
  SELECT usage_sms.id + {$deltaAccountTariff},
      clients.id,
      {$serviceTypeId},
      NULL,
      NULL,
  ...
  FROM usage_sms,
    clients
  WHERE usage_sms.client = clients.client
    AND usage_sms.actual_to BETWEEN '2000-01-01' AND '2020-01-01'");
