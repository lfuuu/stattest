...
class m160425_154021_wizard_t2t_flags extends \app\classes\Migration
{
    public function up()
    {
        $this->addColumn(LkWizardState::tableName(), 'is_rules_accept_legal', $this->integer(1)->notNull()->defaultValue(0));
        $this->addColumn(LkWizardState::tableName(), 'is_rules_accept_person', $this->integer(1)->notNull()->defaultValue(0));
        $this->addColumn(LkWizardState::tableName(), 'is_contract_accept', $this->integer(1)->notNull()->defaultValue(0));
