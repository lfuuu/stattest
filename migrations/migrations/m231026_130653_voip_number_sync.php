...
/**
 * Class m231026_130653_voip_number_sync
 */
class m231026_130653_voip_number_sync extends \app\classes\Migration
{
    /**
     * Up
     */
    ...
    {
        $this->executeRaw("DROP TRIGGER sync_voip_numbers_update");
...
SQL;
    ...
    public function safeDown()
    {
        $this->executeRaw("DROP TRIGGER sync_voip_numbers_update");
        $sql = <<<SQL
CREATE DEFINER=`stat_operator`@`localhost` TRIGGER `sync_voip_numbers_update` AFTER UPDATE ON `voip_numbers` FOR EACH ROW BEGIN
