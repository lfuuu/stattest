    ...
    private function __construct()
    {
        ...
        $this->addBlock(
            NavigationBlock::create()
                ...
                ->addItem('Названия событий', ['/important_events/names'], ['dictionary.important-events-names'])
                ->addItem('Группы событий', ['/important_events/groups'], ['dictionary.important-events-groups'])
                ->addItem('Источники событий', ['/important_events/sources'], ['dictionary.important-events-sources'])
