...
TEXT;
        ...
        return [
            ...
            [
                'payerName' => 'АО "ТИНЬКОФФ БАНК"',
                "paymentPurpose" => "Пополнение по операции СБП 2537146230. Терминал MCN Telecom",
                'payerInn' => '7710140679',
            ],
            [
                'payerName' => 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "АБОНЕНТ СЕРВИС"',
                "paymentPurpose" => 'Плата за пополнение по операции СБП 2537146230. Терминал MCN Telecom. Договор 7048663251',
                'payerInn' => '7728892052',
            ],
            [
                "paymentPurpose" => "Возврат по операции СБП 2538621785. Терминал MCN Telecom",
            ],

            [
                'recipientInn' => '7728892052',
                'recipientKpp' => '772801001',
                'payerInn' => '7710140679',
                'paymentPurpose' => 'Перевод средств по договору C_334812 от 07.09.2022г. (MCN Telecom) по Реестру операций от 27.03.2023. Сумма комиссии 57 руб. 22 коп., НДС не облагается.',
            ],

            [
                'payerName' => 'АЛЕКСАШКИНА НИНА АЛЕКСЕЕВНА',
                "paymentPurpose" => "Перевод с карты *4348, Предоплата по лицевому счету №120202 за телекоммуникационные услуги. НДС не облагается",
                'payerInn' => '742202640259',
            ],

            [
                'payerName' => 'КОЗИК СЕРГЕЙ МИХАЙЛОВИЧ//Г. Москва Г МОСКВА УЛ Б-Р ОРЕХОВЫЙ д.18 кв.298//',
                "paymentPurpose" => "предоплата услуг связи  л/с 91394",
                'payerInn' => '',
            ],
            [
                'payerName' => 'ПАО СБЕРБАНК',
                "paymentPurpose" => "ПО ПЛАТЕЖАМ С 06/03/2023 ПО 06/03/2023,СУММА 10.00,УСЛ.БАНКА:0.20,КОЛ-ВО 1,ЭЛ.РЕЕСТР EPS1577206364335_900005_7728892052_40702810110001055500_001.txt",
                'payerInn' => '7707083893',
            ],
            [
                'payerName' => 'ПАО СБЕРБАНК//ЕМЕЛЬЯНОВ ВЛАДИМИР ЮРЬЕВИЧ//1575834389048//111558,РОССИЯ,МОСКВА Г,Г МОСКВА,ПРОЕЗД САПЁРНЫЙ,Д 2/23 КВ 109//',
                "paymentPurpose" => "ЗА 01/03/2023;Емельянов Владимир Юрьевич;л/с 76395",
                'payerInn' => '7707083893',
            ],
            [
                'payerName' => 'ЕГОРОВСКИЙ ДМИТРИЙ ИГОРЕВИЧ',
                "paymentPurpose" => "Перевод с карты *8008, авансовый платеж за услуги связи. НДС не облагается",
                'payerInn' => '',
            ],
            [
                'payerName' => 'ПОСТНИКОВА ЕЛЕНА АФАНАСЬЕВНА',
                "paymentPurpose" => "Перевод с карты *3268, Авансовый платеж за услуги связи. НДС не облагается",
                'payerInn' => '575301238389',
            ],
            [
                'payerName' => 'БИБАНАЕВ ДЕНИС ЮРЬЕВИЧ',
                "paymentPurpose" => "Перевод с карты *6045, ЛС 0; Предоплата по лицевому счету №98846 за телекоммуникационные услуги. НДС не облагается",
                'payerInn' => '771385216066',
            ],
