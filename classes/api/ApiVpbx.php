...
SQL;
    ...
    private function _getTariffUniversal($usageId)
    {
        ...
        return [
            'num_ports' => $accountTariff->getResourceValue(ResourceClass::ID_VPBX_ABONENT),
            'space' => 0, // $accountTariff->getResourceValue(Resource::ID_VPBX_DISK) * 1024, // трафик устанавливается не заранее, а по факту
            'is_record' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_RECORD),
            'is_fax' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_FAX),
            'ext_did' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_EXT_DID),
            ...
            'enable_geo' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_GEO_ROUTE),
            'enable_min_price' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_MIN_ROUTE),
            'enable_sub_accounts' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_SUB_ACCOUNT),
            'voice_assistant' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_VOICE_ASSISTANT),
            'robot_controller' => (int)$accountTariff->getResourceValue(ResourceClass::ID_VPBX_ROBOT_CONTROLLER),
        ];
    }
}
