...
return [
    ...
    'voip_operator_trunk_orig' => 'Платный трафик со стороны оператора по транку {service}{date_range}',
    'voip_operator_trunk_term' => 'Платный трафик на оператора по транку {service}{date_range}',
];
