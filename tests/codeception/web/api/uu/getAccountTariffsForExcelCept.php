...
class GetAccountTariffsForExcelCept extends ApiExternalTest
{
    protected $apiUrl = '/api/internal/uu/get-account-tariffs-for-excel';
    protected $title = 'Get account tariffs for Excel';
...
$context = new GetAccountTariffsForExcelCept(new _WebTester($scenario));
