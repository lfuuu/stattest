...
class getAccountTariffsCept extends ApiExternalTest
{
    protected $apiUrl = '/api/internal/uu/get-account-tariffs';
    protected $title = 'Get account tariffs';
...
$context = new getAccountTariffsCept(new _WebTester($scenario));
