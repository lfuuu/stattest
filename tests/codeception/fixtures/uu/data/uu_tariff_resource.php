...
$allTariffResources = [
    ...
    [
        ...
        'price_per_unit' => 118,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VPBX_DISK,
    ...
    [
        ...
        'price_per_unit' => 98,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VOIP_LINE,
    ...
    [
        ...
        'price_per_unit' => 98,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VOIP_FMC,
        'tariff_id' => Tariff::DELTA + 4,
    ],
    [
        'amount' => 1,
        'price_per_unit' => 99,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VOIP_MOBILE_OUTBOUND,
        'tariff_id' => Tariff::DELTA + 4,
    ],
    ...
    [
        ...
        'price_per_unit' => 39,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VOIP_PACKAGE_SMS,
    ...
    [
        ...
        'price_per_unit' => 0,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_VOIP_PACKAGE_INTERNET,
    ...
    [
        ...
        'price_per_unit' => 1,
        'price_min' => 0,
        'resource_id' => ResourceClass::ID_TRUNK_PACKAGE_ORIG_CALLS,
