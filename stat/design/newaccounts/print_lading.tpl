...
<td align="right">{$line.sum|round:2} | {$line.sum_without_tax|round:2}</td>
<td align="right">{$line.line_nds|round:0}</td>
<td align="right">{$line.tax|round:2} | {$line.sum_tax|round:2}</td>
<td align="right">{$line.tsum|round:2} | {$line.sum_with_tax|round:2}</td>
</tr>
{/foreach}
...
<td align="right">Х </td>
<td align="right">{$bill.sum|round:2} | {$line.sum_without_tax|round:2}</td>
<td align="right">Х </td>
<td align="right">{$bill.tax} | {$line.sum_tax|round:2}</td>
<td align="right">{$bill.tsum|round:2} | {$line.sum_with_tax|round:2}</td>
</tr>
<tr>
...
<td align="right">{$bill.sum|round:2} | {$line.sum_without_tax|round:2}</td>
<td align="right">Х </td>
<td align="right">{$bill.tax|round:2} | {$line.sum_tax|round:2}</td>
<td align="right">{$bill.tsum|round:2} | {$line.sum_with_tax|round:2}</td>
</tr>
</table>
<hr>
