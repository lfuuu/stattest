    ...
    <body bgcolor="#FFFFFF" text="#000000">
        ...
        <div align="center">
            <h2>
                ...
                Акт &#8470;{if !$inv_number}{$bill.bill_no}{$inv_no}{else}{$inv_number}{/if}{if $invoice.drafted_new_date}{$invoice.drafted_new_date|mdate:"d.m.Y г."}{else}{if !$without_date_date} от {$inv_date|mdate:"d.m.Y г."}{else} от {$without_date_date|mdate:"d.m.Y г."}{/if}{/if}
