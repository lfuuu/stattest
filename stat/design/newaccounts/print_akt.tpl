<html>
    ...
    <body bgcolor="#FFFFFF" text="#000000">
        <table width=95%>
            <tr>
                <td>
                    ...
                    Адрес: <strong>{$bill_client.address_post}</strong><br />
        ...
        <br />
        <br />
        {if $organization.is_simple_tax_system}*НДС не облагается: Упрощенная система налогообложения, ст. 346.11 НК РФ.{/if}
        <br />
        <br />
