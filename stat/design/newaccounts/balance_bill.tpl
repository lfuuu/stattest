...
<tr><th>&nbsp;</th><th>клиент</th><th>компания</th><th>дата/н счёта</th><th>счёт</th>{if $b_show_bonus}<th>бонус</th>{/if}<th title="Менеджер клиента">М. клиента</th><th title="Менеджер счета">М. счета</th></tr>
