...
<body bgcolor="#FFFFFF" style="BACKGROUND: #FFFFFF" >
    ...
    {if $sign == 'istomina'}
        ...
        <div style="position:absolute; z-index:100; left:200px; margin-left:-160px;margin-top:-{$firma.height}">
    ...
    {elseif $sign == 'director'}
        ...
        <div style="position:absolute; z-index:100; left:200px; margin-left:-120px;margin-top:-{$firma.height}">
            <img src="{$WEB_PATH}images/{$firma.src}"{if $firma.width} width="{$firma.width}" height="{$firma.height}"{/if} />
        </div>
    {/if}
</body>
