...
{else}
    <div>
    <b>
        <div style="display: inline-block; min-width: 130px;"> Редактирование клиента <a href="/client/view?id={$client.client}" style="font-size:14px; color: {if $client.is_active}green{else}black{/if};">{$client.id}</a> :</div>
