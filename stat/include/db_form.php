        ...
        $v=(
            ...
            &&
                $db->GetRow($q='
                    ...
                    where
                        (
                            (actual_from < "3000-01-01" and actual_from between "'.addslashes($this->dbform['actual_from']).'" and "'.addslashes($this->dbform['actual_to']).'")
                        or
                            (actual_to < "3000-01-01" and actual_to between "'.addslashes($this->dbform['actual_from']).'" and "'.addslashes($this->dbform['actual_to']).'")
                        )
                    and
