        ...
        if ($model) {
            return [
                'tariff' => $model->tariffPeriod ?
                    AccountTariffStructureGenerator::me()->_getTariffRecord($model->tariffPeriod->tariff, $model->tariffPeriod, $minutesStatistic, $internetStatistic, $priceMinutesStatistic, $smsStatistic) :
                    null,
