      <TABLE class=mform cellSpacing=4 cellPadding=2 width="100%" border=0>
		...
		<SELECT name=y>
			<OPTION value=2005{if $y==2005} selected{/if}>2005</OPTION>
			<OPTION value=2006{if $y==2006} selected{/if}>2006</OPTION>
			<OPTION value=2007{if $y==2007} selected{/if}>2007</OPTION>
			<OPTION value=2008{if $y==2008} selected{/if}>2008</OPTION>
			<OPTION value=2009{if $y==2009} selected{/if}>2009</OPTION>
		</SELECT> 
        по:
          <SELECT name=ed>
		...
		<SELECT name=ey>
			<OPTION value=2005{if $ey==2005} selected{/if}>2005</OPTION>
			<OPTION value=2006{if $ey==2006} selected{/if}>2006</OPTION>
			<OPTION value=2007{if $ey==2007} selected{/if}>2007</OPTION>
			<OPTION value=2008{if $ey==2008} selected{/if}>2008</OPTION>
			<OPTION value=2009{if $ey==2009} selected{/if}>2009</OPTION>
		</SELECT> 
        </TD></TR>
        <TR>
