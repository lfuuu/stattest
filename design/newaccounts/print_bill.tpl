...
<b>Поставщик: ООО "МАРКОМНЕТ"</b><br>
...
р/с:&nbsp;40702810100540001508 в ОАО "УРАЛСИБ" Г. МОСКВА<br>
к/с:&nbsp;30101810100000000787<br>
БИК:&nbsp;044525787<br>
...
Факс: (495) 638-50-17<br>
р/с:&nbsp;40702810600301422002 в ЗАО КБ "Ситибанк"<br>
...
<!--Факс: (495) 638-5184, 137-2674<br>-->
Факс: (495) 638-50-17<br>
р/с:&nbsp;40702810300070015232 в АКБ "Пробизнесбанк" (ОАО)<br>
...
<img border="0" src="{if $is_pdf == '1'}{$WEB_PATH}{/if}{$IMAGES_PATH}logo_all4net.gif">
{elseif $bill_client.firma == "mcn"}
<img border="0" src="{if $is_pdf == '1'}{$WEB_PATH}{/if}{$IMAGES_PATH}logo2.gif">
{elseif $bill_client.firma == "mcn_telekom"}
<img border="0" src="{if $is_pdf == '1'}{$WEB_PATH}{/if}{$IMAGES_PATH}mcntelecom-logo.png"  width=115 height=25 style="">
www.mcntelecom.ru
{/if}
</div>
  ...
  {if $bill_client.client != "salvus"}
    <table border="0" align="right">
      ...
      <tr valign=top bgcolor="{$color}">
        <td>Менеджер</td>
        <td nowrap>{$bill_client.manager_name|replace:" ":"&nbsp;"}</td>
      </tr>
      <tr>
...
<tr>
    ...
    <td align="center" nowrap><b>Количество</b></td>
...
<tr>
        ...
        <td align="center">{if $line.okvd_code}{$line.okvd}{else}{if $line.type == "service"}-{else}шт.{/if}{/if}</td>
