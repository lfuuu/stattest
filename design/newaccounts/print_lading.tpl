...
{elseif $bill_client.firma=='all4net'}
	ООО &quot;Олфонет&quot;, 117218, г.Москва, ул. Большая
    Черемушкинская д. 25, стр. 97, тел: 638-7777<br />
...
{elseif $bill_client.firma=='ooomcn'}
	{if '2009-06-01' < $bill.bill_date || ($bill.bill_date eq '2009-06-01' && $invoice_source <> 2)}Общество с ограниченной ответственностью "МСН" (ООО "МСН"){else}ООО "МСН"{/if}, 117574 г. Москва, Одоевского пр-д., д. 3, кор. 7, тел: 950-5678 доб 159<br />
...
{else}
	ООО &quot;Эм Си Эн&quot;, 113452 г. Москва, Балаклавский пр-т., д. 20, кор. 4 кв. 130, тел: 950-5678<br />
р/с:&nbsp;40702810600301422002 в ЗАО КБ &laquo;Ситибанк&raquo; Корр/с:&nbsp;30101810300000000202<br>
ИНН/КПП 7727508671/772701001<br>
БИК:&nbsp;044525202<br>
...
{capture name=from_send}
  {if $bill_client.firma=='all4geo'}
    ...
    р/с 40702810038110016607 в ОАО Сбербанк России, Корр/с 30101810400000000225<br />ИНН/КПП 7727752091/772401001 БИК 044525225
{elseif $bill_client.firma=='all4net'}
ООО &quot;Олфонет&quot;, 117218, г.Москва, ул. Большая Черемушкинская д. 25, стр. 97, тел: 638-7777<br />
р/с 40702810500540000002 в ОАО &laquo;УРАЛСИБ&raquo;, Корр/с 30101810100000000787<br />ИНН/КПП 7727731060/772701001 БИК 044525787
{elseif $bill_client.firma=='ooocmc'}
	{if '2009-06-01' < $bill.bill_date || ($bill.bill_date eq '2009-06-01' && $invoice_source <> 2)}Общество с ограниченной ответственностью "Си Эм Си" (ООО "Си Эм Си"){else}ООО "Си Эм Си"{/if}, 117218, г. Москва, ул. Большая Черемушкинская, д. 25, стр. 97<br />
р/с 40702810800540001507 в ОАО "УРАЛСИБ", Корр/с 30101810100000000787<br />ИНН/КПП продавца: 7727701308/772701001 БИК 044525787
...
{else}
ООО &quot;Эм Си Эн&quot;, 113452 г. Москва, Балаклавский пр-т., д. 20, кор. 4 кв. 130, тел: 950-5678<br />
<!-- р/с 40702810700320000882 в ОАО &laquo;Банк Москвы&raquo; Подольское ш.,д.8,стр, 5, Корр/с 30101810500000000219<br />ИНН/КПП 7727508671/772701001 БИК 044525219-->
р/с:&nbsp;40702810600301422002 в ЗАО КБ &laquo;Ситибанк&raquo; Корр/с:&nbsp;30101810300000000202<br>
ИНН/КПП 7727508671/772701001<br>
БИК:&nbsp;044525202<br>
{/if}
