...
<TBODY>
<TR><TD width=50% class=left>id:</TD><td><input type=text value='{$row.id.value}' name=$row['id']></td></tr>
...
<TR><TD class=left>Увеличивать время трабла на (в часах; отрицательное число - для уменьшения):</TD><td><input type=text value='{$row.approx.value}' name=$row['approx']></td></tr>
</TBODY></TABLE>
