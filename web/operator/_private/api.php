...
function say($status, $data)
{
	...
	Yii::info('StatApi response: ' . json_encode($say, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT));
	echo json_encode($say, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
...
function do_func($function)
{
	switch($function)
	{
        ...
        case 'getFreeNumbers': return ApiLk::getFreeNumbers(get_param_raw("client_id"), get_param_raw("city_id"), get_param_raw("did_group_id")); break;
		...
		case 'orderVoip': return ApiLk::orderVoip(get_param_raw("client_id"), get_param_raw("did")); break;
		...
		case 'getStatisticsVoipData': return ApiLk::getStatisticsVoipData(get_param_raw("client_id"), get_param_raw("phone"), get_param_raw("from"), get_param_raw("to"), get_param_raw("detality"), get_param_raw("destination"), get_param_raw("direction"), get_param_raw("timezone"), get_param_raw("onlypay"), get_param_raw("is_full")); break;
