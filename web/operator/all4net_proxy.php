<?php
	...
	file_put_contents(dirname(__FILE__)."/../../stat/log/all4net.log", $datetime.' --- '.var_export($var,true)."\n",FILE_APPEND);
	...
	try{
		...
		file_put_contents(dirname(__FILE__)."/../../stat/log/all4net.log", 'Error:'.$e->getCode()."\n\n\n====\n\n",FILE_APPEND);
		exit();
	}
	...
	echo $bill_no;
	file_put_contents(dirname(__FILE__)."/../../stat/log/all4net.log", "bn:".$bill_no."\n\n\n===\n\n",FILE_APPEND);
	exit();
?>