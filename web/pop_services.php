...
switch ($table) {
    case 'usage_ip_ports':
        if (!access('services_internet', 'edit') && !access('services_collocation', 'edit')) {
            return;
        }
        break;
    ...
    case 'usage_voip':
        ...
        break;
    case 'domains':
        if (!access('services_domains', 'edit')) {
            return;
        }
        break;
    case 'usage_ip_ppp':
        if (!access('services_ppp', 'edit')) {
            return;
        }
        break;
    case 'usage_extra':
        if (!access('services_additional', 'edit')) {
            return;
        }
        break;
    case 'emails':
        ...
        break;
    case 'usage_welltime':
        if (!access('services_welltime', 'full')) {
            return;
        }
        break;
    case 'usage_virtpbx':
